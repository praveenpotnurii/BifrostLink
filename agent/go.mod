module github.com/bifrost/poc

go 1.23.8

replace (
	github.com/bifrost/common => ../common
	github.com/bifrost/poc/libbifrost => ./libbifrost
)
...
require (
	...
	github.com/bifrost/poc/libbifrost v0.0.0-00010101000000-000000000000
