...
import (
	...
	llog "github.com/bifrost/poc/libbifrost/llog"

	agentconfig "github.com/bifrost/poc/config"
	"github.com/bifrost/poc/controller"
	"github.com/bifrost/common/backoff"
	...
	"github.com/bifrost/common/monitoring"
	pb "github.com/bifrost/common/proto"
	"github.com/bifrost/common/version"
	"google.golang.org/grpc/codes"
	"google.golang.org/grpc/status"
)

var (
	defaultUserAgent       = fmt.Sprintf("bifrostagent/%v", version.Get().Version)
	vi                     = version.Get()
...
func Run() {
	// Reinitialize libbifrost logger to use the same log format configured in client
